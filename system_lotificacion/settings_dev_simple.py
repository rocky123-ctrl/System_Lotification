"""
#settings_dev_simple.py
Configuración de Django para desarrollo local SIN Redis.
...
# IMPORTANTE: Cambia la contraseña por la que configuraste en PostgreSQL
DATABASES = {
    'default': {
...
# Cache configuration - Usar cache en memoria para desarrollo
CACHES = {
    'default': {
...
ADMIN_INDEX_TITLE = "Bienvenido al Sistema de Lotificación - Modo Simple"
