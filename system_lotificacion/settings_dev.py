...
MIDDLEWARE = [
    ...
    'permissions.middleware.AuditMiddleware',
]

ROOT_URLCONF = 'system_lotificacion.urls'
...
WSGI_APPLICATION = 'system_lotificacion.wsgi.application'

# Database - Configuración local para desarrollo
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'system_lotificacion'),
        'USER': os.environ.get('DB_USER', 'postgres'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'postgres'),  # Cambia esto por tu contraseña de PostgreSQL
...
# Redis Configuration - Configuración local
...
# Inactivity setting
INACTIVITY_TIMEOUT_SECONDS = int(os.environ.get("INACTIVITY_TIMEOUT_SECONDS", 600))
...
ADMIN_SITE_HEADER = "Sistema de Lotificación - Administración"
ADMIN_SITE_TITLE = "Sistema de Lotificación"
ADMIN_INDEX_TITLE = "Bienvenido al Sistema de Lotificación"
